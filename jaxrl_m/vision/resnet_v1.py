...
resnetv1_configs = {
    'resnetv1-18': partial(ResNetEncoder, stage_sizes=(2, 2, 2, 2),
                           block_cls=ResNetBlock),
    'resnetv1-34': partial(ResNetEncoder, stage_sizes=(3, 4, 6, 3),
                           block_cls=ResNetBlock),
    'resnetv1-50': partial(ResNetEncoder, stage_sizes=[3, 4, 6, 3],
                           block_cls=BottleneckResNetBlock),
    'resnetv1-18-deeper': partial(ResNetEncoder, stage_sizes=(3, 3, 3, 3),
                                  block_cls=ResNetBlock),
    'resnetv1-18-deepest': partial(ResNetEncoder, stage_sizes=(4, 4, 4, 4),
                                   block_cls=ResNetBlock),
