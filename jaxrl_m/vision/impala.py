...
impala_configs = {
    ...
    'impala_large': partial(ImpalaEncoder, stack_sizes=(16, 32, 32, 32)),
    'impala_larger': partial(ImpalaEncoder, stack_sizes=(16, 32, 32, 32, 32)),
    'impala_largest': partial(ImpalaEncoder, stack_sizes=(16, 32, 32, 32, 32, 32)),
    'impala_wider': partial(ImpalaEncoder, width=2),
    'impala_widest': partial(ImpalaEncoder, width=4),
    'impala_deeper': partial(ImpalaEncoder, num_blocks=4),
    'impala_deepest': partial(ImpalaEncoder, num_blocks=8),
}
